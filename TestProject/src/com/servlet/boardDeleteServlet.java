...
//		PrintWriter out = response.getWriter();
		...
		if(result > 0) {
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/boardDeleteSuccess.jsp");
...
//			out.println("</html>                                                                                      ");
			...
			RequestDispatcher rd = request.getRequestDispatcher("/jsp/boardDeleteFailed.jsp");
			rd.forward(request, response);
//			out.println("<!DOCTYPE html>                                                                              ");
//			out.println("<html>                                                                                       ");
//			out.println("<head>                                                                                       ");
